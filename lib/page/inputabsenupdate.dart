...
import 'package:moyan/page/datakeluargaupdate.dart';
import 'package:moyan/page/selesaiabsen.dart';
import 'package:moyan/page/validasiabsen.dart';
import 'package:moyan/tema.dart';

class Inputabsenupdate extends StatefulWidget {
  final String empid;
  final String ipadress;
  const Inputabsenupdate(
      {super.key, required this.empid, required this.ipadress});

  @override
  State<Inputabsenupdate> createState() => _InputabsenupdateState();
}

class _InputabsenupdateState extends State<Inputabsenupdate> {
  ...
  get() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Datakeluargaupdate(
          empid: widget.empid,
