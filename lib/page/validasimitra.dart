...
class Validasimitra extends StatefulWidget {
  final String empid;
  final String ipadress;
  Validasimitra({super.key, required this.empid, required this.ipadress});

  @override
  State<Validasimitra> createState() => _ValidasimitraState();
}

class _ValidasimitraState extends State<Validasimitra> {
  Widget header() {
    return Container(
      height: 200,
      child: Stack(
